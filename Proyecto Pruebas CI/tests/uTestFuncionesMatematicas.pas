...
type
  ...
  public
    ...
    procedure TestFunctionSuma(const AValue1:Integer; const AValue2:Integer; AResult:integer);
    ...
    procedure TestFunctionDivision(const AValue1:Integer; const AValue2:Integer; AResult:double);
